...
flash_chip_type  flash_chip_list[] =
{
    ...
    { 0x007f, 0x2249, size2MB, CMD_TYPE_AMD, "EON EN29LV160AB 1Mx16 BotB  (2MB)"   ,1,size16K,    2,size8K,     1,size32K,  31,size64K },
    { 0x007f, 0x22C4, size2MB, CMD_TYPE_AMD, "EON EN29LV160AT 1Mx16 TopB  (2MB)"   ,31,size64K,   1,size32K,    2,size8K,   1,size16K  },
